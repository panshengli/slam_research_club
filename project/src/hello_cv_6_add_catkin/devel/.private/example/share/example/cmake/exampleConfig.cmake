...
if("TRUE" STREQUAL "TRUE")
  set(example_SOURCE_PREFIX /media/henry_pan/Data/slam_research_club/project/src/hello_cv_6_add_catkin/src/example)
  set(example_DEVEL_PREFIX /media/henry_pan/Data/slam_research_club/project/src/hello_cv_6_add_catkin/devel/.private/example)
  set(example_INSTALL_PREFIX "")
  set(example_PREFIX ${example_DEVEL_PREFIX})
else()
  set(example_SOURCE_PREFIX "")
  set(example_DEVEL_PREFIX "")
  set(example_INSTALL_PREFIX /media/henry_pan/Data/slam_research_club/project/src/hello_cv_6_add_catkin/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/henry_pan/Data/slam_research_club/project/src/hello_cv_6_add_catkin/src/example/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/henry_pan/Data/slam_research_club/project/src/hello_cv_6_add_catkin/devel/.private/example/lib;/media/henry_pan/Data/slam_research_club/project/src/hello_cv_6_add_catkin/devel/lib;/opt/ros/kinetic/lib)
